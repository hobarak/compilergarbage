...
instance Foldable Expr where
  foldMap f (App _ xs a) = (foldMap . foldMap) f xs <> f a
  ...
  foldMap f (Tuple xs a) = (foldMap . foldMap) f xs <> f a
  foldMap f (Index l r a) = foldMap f l <> foldMap f r <> f a
...
instance Traversable Expr where
  ...
  traverse f (Tuple xs a) = Tuple <$> (traverse . traverse) f xs <*> f a
  traverse f (Index l r a) = Index <$> traverse f l <*> traverse f r <*> f a
